...
CTX_ISO2C         <- "PT"
CTX_COUNTRY       <- "Portugal"
CTX_ELEC_ID       <- "PT-2022-01"
CTX_ELEC_ID_LAG   <- "PT-2019-10"
CTX_ELECTION_DATE <- as.Date("2022-01-30")
CTX_ELECTION_LAG  <- as.Date("2019-10-06")
CTX_YEAR          <- 2022L
...
output_rdata_full <- file.path(output_dir, "pt_2022_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "pt_2022_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "pt_2022_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "pt_2022_df_long_valid_both.RData")
...
party_parlgov <- tibble::tribble(
  ...
  "Socialist Party", 702L,
  "Social Democratic Party", 552L,
  "Enough", 2837L,
  "Liberal Initiative", 2836L,
  "Left Bloc", 1707L,
  "Unitarian Democratic Coalition", 329L,
  "CDS-PP", 1247L,
  "PAN", 2681L,
  "Free", 2838L
)
...
party_family_map <- tibble::tribble(
  ...
  "Enough", "nat",
  "Liberal Initiative", "lib",
  "Left Bloc", "lef",
  "Unitarian Democratic Coalition", "com",
  "CDS-PP", "chr",
  "PAN", "eco",
  "Free", "eco"
)
...
cat("\nPortugal 2022 completed successfully\n")
