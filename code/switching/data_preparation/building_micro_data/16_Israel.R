...
input_rdata  <- "C:/Users/koend/OneDrive/Bureaublad/UVA/R_Project/VoteSwitching/VoteSwitching/data/micro/il_data_file.RData"
output_dir   <- "C:/Users/koend/OneDrive/Bureaublad/UVA/R_Project/VoteSwitching/VoteSwitching/data/micro"

output_rdata_full <- file.path(output_dir, "il_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "il_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "il_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "il_df_long_valid_both.RData")

# ------------------------------------------------
# 4. Optionally load previously built data_file object
# ------------------------------------------------
...
# ------------------------------------------------
# 10. Optional save of built data_file object
# ------------------------------------------------
if (!file.exists(input_rdata)) {
  save(data_file, file = input_rdata)
  
  cat("\nSaved built data_file to:\n")
  cat(input_rdata, "\n")
}
