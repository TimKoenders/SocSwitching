...
CTX_ELEC_ID_LAG   <- "DNK-2019-06"
CTX_ELECTION_DATE <- as.Date("2022-11-01")
CTX_ELECTION_LAG  <- as.Date("2019-06-05")
CTX_YEAR          <- 2022L
...
output_rdata_full <- file.path(output_dir, "dk_2022_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "dk_2022_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "dk_2022_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "dk_2022_df_long_valid_both.RData")
...
party_family_map <- tibble::tribble(
  ...
  "Venstre, Denmark's Liberal Party",   "lib",
  "Moderates",                          "lib",
  "Socialist People's Party",           "soc",
  "Denmark Democrats - Inger Stojberg", "nat",
  "Liberal Alliance",                   "lib",
  "Conservative People's Party",        "con",
  "Unity List - Red-Green Alliance",    "com",
  "Danish Social Liberal Party",        "lib",
  "The New Right",                      "nat",
  "The Alternative",                    "eco",
  "Danish People's Party",              "nat",
  "Independent Greens",                 "eco",
  "Christian Democrats",                "chr",
  "Hard Line",                          "nat",
  "Klaus Riskaer Pedersen List",        "lib"
)
