...
CTX_ISO2C         <- "NZ"
CTX_COUNTRY       <- "New Zealand"
CTX_ELEC_ID       <- "NZ-2023-10"
CTX_ELEC_ID_LAG   <- "NZ-2020-10"
CTX_ELECTION_DATE <- as.Date("2023-10-14")
CTX_ELECTION_LAG  <- as.Date("2020-10-17")
CTX_YEAR          <- 2023L
...
output_rdata_full <- file.path(output_dir, "nz_2023_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "nz_2023_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "nz_2023_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "nz_2023_df_long_valid_both.RData")
...
party_family_map <- tibble::tribble(
  ...
  "Green Party", "eco",
  "ACT New Zealand", "lib",
  "New Zealand First Party", "nat",
  "Maori Party", "eth",
  "The Opportunities Party", "lib",
  "New Zealand Loyal Party", "nat",
  "NewZeal", "oth",
  "Aotearoa Legalise Cannabis Party", "oth",
  "DemocracyNZ", "nat",
  "Animal Justice Party Aotearoa New Zealand", "oth",
  "New Conservatives", "con",
  "Leighton Baker Party", "oth",
  "Advance New Zealand Party", "oth"
)
