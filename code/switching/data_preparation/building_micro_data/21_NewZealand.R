...
input_rdata  <- "C:/Users/koend/OneDrive/Bureaublad/UVA/R_Project/VoteSwitching/VoteSwitching/data/micro/nz_data_file.RData"
output_dir   <- "C:/Users/koend/OneDrive/Bureaublad/UVA/R_Project/VoteSwitching/VoteSwitching/data/micro"

output_rdata_full <- file.path(output_dir, "nz_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "nz_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "nz_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "nz_df_long_valid_both.RData")
...
# ------------------------------------------------
# 4. Minimal diagnostics before cleaning
# ------------------------------------------------
cat("\n========================================\n")
...
validate_subset <- function(dat, name) {
  ...
  cat("\nDistribution of now_matches:\n")
  print(out %>% dplyr::count(now_matches, sort = FALSE))
  
  cat("\nDistribution of lag_matches:\n")
  print(out %>% dplyr::count(lag_matches, sort = FALSE))
}
