...
CTX_ELEC_ID_LAG   <- "PT-2022-01"
CTX_ELECTION_DATE <- as.Date("2024-03-10")
CTX_ELECTION_LAG  <- as.Date("2022-01-30")
CTX_YEAR          <- 2024L
...
output_rdata_full <- file.path(output_dir, "pt_2024_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "pt_2024_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "pt_2024_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "pt_2024_df_long_valid_both.RData")
...
party_family_map <- tibble::tribble(
  ...
  "Free", "com",
  "Party for People, Animals and Nature", "eco"
)
...
cat("\nPortugal 2024 completed successfully\n")
