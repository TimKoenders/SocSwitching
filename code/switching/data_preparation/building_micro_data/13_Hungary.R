...
input_rdata  <- "C:/Users/koend/OneDrive/Bureaublad/UVA/R_Project/VoteSwitching/VoteSwitching/data/micro/hu_data_file.RData"
output_dir   <- "C:/Users/koend/OneDrive/Bureaublad/UVA/R_Project/VoteSwitching/VoteSwitching/data/micro"

output_rdata_full <- file.path(output_dir, "hu_df_long_full.RData")
output_rdata_now  <- file.path(output_dir, "hu_df_long_valid_now.RData")
output_rdata_lag  <- file.path(output_dir, "hu_df_long_valid_lag.RData")
output_rdata_both <- file.path(output_dir, "hu_df_long_valid_both.RData")
